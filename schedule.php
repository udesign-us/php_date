...
<nav id="schedule">
    <ul id="schedule">
        <li><a href="schedule.php?<?php echo 'month=' . $m_p . '&day=' . $d_p . '&year=' . $y_p; ?>"><?php echo "<<" . "<br>" . ". ";; ?></a></li>
         
        <li><a class="active" href="schedule.php?<?php echo 'month=' . $m . '&day=' . $d . '&year=' . $y; ?>"><?php echo $last_date_l; ?>  <br>  <?php echo $last_date_l_m; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_1 . '&day=' . $d_1 . '&year=' . $y_1; ?>"><?php echo $new_date_l_1; ?>  <br>  <?php echo $new_date_l_m_1; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_2 . '&day=' . $d_2 . '&year=' . $y_2; ?>"><?php echo $new_date_l_2; ?>  <br>  <?php echo $new_date_l_m_2; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_3 . '&day=' . $d_3 . '&year=' . $y_3; ?>"><?php echo $new_date_l_3; ?>  <br>  <?php echo $new_date_l_m_3; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_4 . '&day=' . $d_4 . '&year=' . $y_4; ?>"><?php echo $new_date_l_6; ?>  <br>  <?php echo $new_date_l_m_4; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_5 . '&day=' . $d_5 . '&year=' . $y_5; ?>"><?php echo $new_date_l_5; ?>  <br>  <?php echo $new_date_l_m_5; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_6 . '&day=' . $d_6 . '&year=' . $y_6; ?>"><?php echo $new_date_l_6; ?>  <br>  <?php echo $new_date_l_m_6; ?></a></li>
        
        <li><a href="schedule.php?<?php echo 'month=' . $m_n . '&day=' . $d_n . '&year=' . $y_n; ?>"><?php echo ">>" . "<br>" . ". "; ?></a></li>
    </ul>
